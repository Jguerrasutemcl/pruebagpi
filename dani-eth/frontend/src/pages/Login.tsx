...
export default function LoginPage() {
  // 1. EXTRAEMOS resetPassword DEL CONTEXTO
  ...
  // 2. AÑADIMOS UN ESTADO PARA EL MENSAJE DE ÉXITO
  ...
  // 3. AÑADIMOS LA FUNCIÓN PARA RECUPERAR CONTRASEÑA
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-bg-secondary border border-border-primary rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Password */}
            <div>
              {/* 4. MODIFICAMOS EL CONTENEDOR DEL LABEL PARA INCLUIR EL BOTÓN */}
              <div className="flex justify-between items-center mb-1.5">
                ...
                <button
                  ...
                  className="text-sm text-accent-cyan hover:underline focus:outline-none"
                  disabled={submitting}
                >
            ...
            {/* 5. AÑADIMOS EL MENSAJE DE ÉXITO */}
            {message && (
              <div className="px-3 py-2.5 rounded-lg bg-green-500/10 border border-green-500/30 text-green-500 text-sm">
                {message}
              </div>
            )}
