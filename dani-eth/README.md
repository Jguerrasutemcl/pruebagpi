...
> Orquestador inteligente de pentesting basado en IA (DeepSeek) que automatiza el descubrimiento, validación y remediación de vulnerabilidades.
...
**Backend**: FastAPI, Python 3.11, Firebase Admin SDK, Pydantic v2.
